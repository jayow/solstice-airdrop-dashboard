"""S2_HOLD_EUSX_3MO (10×) — ground-truth walker.

Source-of-truth: every SPL token account on the EUSX mint.
Fires when wallet holds ≥$100 continuously for ≥90d.
"""
import os, sys, time
        ...
        def process(w):
            if not force_refresh:
                ...
                if cached and (now_ts - (cached.get('extracted_at') or 0)) < 24*3600 \
                   and not is_hold_cache_stale(cached, w, 'S2_HOLD_EUSX_DAILY'):
